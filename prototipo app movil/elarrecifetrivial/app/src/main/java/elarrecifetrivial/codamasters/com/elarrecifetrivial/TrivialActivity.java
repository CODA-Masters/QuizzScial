...
/**
 * Created by Juan on 26/12/2015.
 */
public class TrivialActivity extends AppCompatActivity {


    private static final int NUM_AVAIBLE_QUESTIONS = 8;
    private static final int NUM_QUESTIONS=5;
    private TextView textView;
    private Button option1, option2, option3, option4, back_menu, show_video, next_question;
    ...
    private void initQuestionView(){
        ...
        option1 = (Button) findViewById(R.id.text_option1);
        option2 = (Button) findViewById(R.id.text_option2);
        option3 = (Button) findViewById(R.id.text_option3);
        option4 = (Button) findViewById(R.id.text_option4);
    ...
    private void deactivateButtons(){
        option1.setBackground(getResources().getDrawable(R.drawable.custom_btn_deactivated));
        option2.setBackground(getResources().getDrawable(R.drawable.custom_btn_deactivated));
        option3.setBackground(getResources().getDrawable(R.drawable.custom_btn_deactivated));
        option4.setBackground(getResources().getDrawable(R.drawable.custom_btn_deactivated));
    }
    ...
    private void addButtonListeners(){
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stop=true;
                if (option1.getText().equals(question.getRight_answer())) {
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stop=true;
                if (option2.getText().equals(question.getRight_answer())) {
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stop=true;
                if (option3.getText().equals(question.getRight_answer())) {
        ...
        option4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stop=true;
                if (option4.getText().equals(question.getRight_answer())) {
        ...
        back_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TrivialActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        show_video.setOnClickListener(null);
    ...
    private void restartButtonBackground(){
        ...
        show_video.setBackground(getResources().getDrawable(R.drawable.custom_btn_deactivated));
    ...
    private void initBackgroundAfterResponse(){
        show_video.setBackground(getResources().getDrawable(R.drawable.custom_btn));
    ...
    private void initListenersAfterResponse(){
        ...
        show_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse(question.getUrl_video());
            ...
            public void onClick(View v) {
                if (i_question < NUM_QUESTIONS) {
                    ...
                    if (question.getType() == Question.IMAGE_QUESTION) {
                        Intent intent = new Intent(TrivialActivity.this, TrivialImageActivity.class);
                        intent.putIntegerArrayListExtra("id_questions", id_questions);
                        intent.putExtra("i_question", i_question);
                        intent.putExtra("score", score);
                        intent.putExtra("time_answer", time_answer);
                        startActivity(intent);
                        finish();
                    } else {
                        updateQuestion();
                    ...
                    Intent intent = new Intent(TrivialActivity.this, ScoreActivity.class);
                    intent.putExtra("score", score);
                    intent.putExtra("time_answer", time_answer);
                    startActivity(intent);
                    finish();
