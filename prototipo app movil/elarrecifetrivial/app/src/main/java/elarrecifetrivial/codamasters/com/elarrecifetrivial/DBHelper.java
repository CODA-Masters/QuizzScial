...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "quizzscial";
    ...
    private void copyDataBase() throws IOException{
        ...
        InputStream myInput = context.getResources().openRawResource(R.raw.quizzscial);
    ...
    void addQuestion(Question question) {
        ...
        if(question.getUrl_video() != null)
            values.put(KEY_URL_VIDEO, question.getUrl_video());
